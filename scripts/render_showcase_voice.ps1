...
$segments = @(
    @{ File = "01_intro.wav"; Text = "Meet Sulcus: an experimental multi-agent operating system." },
    ...
    @{ File = "07_close.wav"; Text = "Sulcus. Build agent systems you can see, understand, and trust." }
)
